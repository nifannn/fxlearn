...
class SGNS(object):
    ...
    def __init__(self, embed_dim=128, window_size=10, random_window=False, distinct_targets=False,
                 ...
                 ns=True, n_sampled=10, ns_method="sampled_softmax",
    ...
    def _train_list(self, feed, epochs=10, batch_size=128,
                    shuffle=True, verbose=False, ns_func=None, ns_func_comment=None):
        ...
        item_count = self._set_item_pools(item_count, True)
        if verbose:
    ...
    def _save_item_vec(self, folder, mode="embed", save_replace_value=False,
        ...
        path = os.path.join(folder, self._get_datetime()+"_embeddings.txt")
    ...
    def _set_item_pools(self, item_count, return_new_count=False):
